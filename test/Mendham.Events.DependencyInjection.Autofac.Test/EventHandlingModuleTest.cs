...
namespace Mendham.Events.DependencyInjection.Autofac.Test
{
    public class EventHandlingModuleTest
    {
        ...
        [Fact]
        public void EventHandlingModule_RegisterEventPublisher_IsSameInstance()
        {
            var builder = new ContainerBuilder();
            builder.RegisterModule<EventHandlingModule>();
        ...
        [Fact]
        public void EventHandlingModule_RegisterEventHandlingContainer_IsSameInstance()
        {
            var builder = new ContainerBuilder();
            builder.RegisterModule<EventHandlingModule>();
            var container = builder.Build();
        ...
        [Fact]
        public void EventHandlingModule_RegisterDomainEventHandlingProcessor_IsSameInstance()
        {
            var builder = new ContainerBuilder();
            builder.RegisterModule<EventHandlingModule>();
            var container = builder.Build();
