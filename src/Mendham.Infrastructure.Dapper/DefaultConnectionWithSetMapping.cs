...
{
    public static class DefaultConnectionWithSetMapping
    {
        private const string DEFAULT_TABLE_NAME = "#Items";
        private const string DEFAULT_COLUMN_NAME = "Value";

        public static IConnectionWithSetMapping<T> Get<T>(string tableName = DEFAULT_TABLE_NAME, string columnName = DEFAULT_COLUMN_NAME)
        {
